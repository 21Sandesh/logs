...
void KeyGeneration(int master_key[], int *k1, int *k2)
{
    // P10
...
void RoundFunction(int *k1, int *l_arr, int *r_arr, int *fk1)
{
...
void SDESEncrypt(int arr[], int *key1, int *key2, int *fk1)
{
    ...
    RoundFunction(key1, l_arr, r_arr, fk1);
    // Swap
    Swap(l_arr, r_arr, 4);
    ...
    RoundFunction(key2, l_arr, r_arr, fk1);
    // ipinv
...
void SDESDecrypt(int arr[], int *key1, int *key2, int *fk1)
{
...
int main()
{
    ...
    KeyGeneration(master_key, k1, k2);
    ...
    if (input == 'b' || input == 'B')
    {
        ...
        SDESEncrypt(arr, k1, k2, fk1);
        for (int i = 0; i < 8; i++)
            arr[i] = fk1[i];
        cout << "_____________________________________________________________________________" << endl;
        SDESDecrypt(arr, k1, k2, fk1);
    }
